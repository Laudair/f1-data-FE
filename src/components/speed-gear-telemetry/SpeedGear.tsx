...
import F1TelemetryChart, { TelemetryData } from '../TelemtryChart'
import { fetchF1TelemetryData } from '../../requests/fetchTelemetry'
import { Button, Select, Box, Text, Spinner } from '@chakra-ui/react'
import { IDriver } from '../../types/driver'

const SpeedGear: React.FC = () => {
  ...
  return (
    <Box style={{ height: '500px', width: '800px', padding: '12px' }}>
      <Text>Speed and Gear Chart</Text>
      <Select
      ...
      <Button onClick={() => fetchData()} style={{ marginTop: '24px' }}>
        Fetch data
      </Button>
      {loading ? (
        <Spinner
